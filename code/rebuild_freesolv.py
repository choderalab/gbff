...
for (key, entry) in database.items():
    ...
    tripos_filename = os.path.join(FREESOLV_PATH, 'tripos_mol2', key + '.mol2')
    frcmod_filename = os.path.join(FREESOLV_PATH, "mol2files_gaff", "%s.frcmod" % key)
    gaff_mol2_filename = os.path.join(FREESOLV_PATH, "mol2files_gaff", "%s.mol2" % key)
    prmtop_filename = os.path.join(FREESOLV_PATH, "mol2files_gaff", "%s.prmtop" % key)
    inpcrd_filename = os.path.join(FREESOLV_PATH, "mol2files_gaff", "%s.inpcrd" % key)
