...
if __name__=="__main__":
    ...
    # Create MCMC model.
    obc1model = model.GBFFThreeParameterModel(database, parameters, utils.compute_hydration_energy, gbmodel=2)

    # Sample models.
    sampler = pymc.MCMC(obc1model.pymc_model, db='hdf5', dbname=mcmcDbName)
